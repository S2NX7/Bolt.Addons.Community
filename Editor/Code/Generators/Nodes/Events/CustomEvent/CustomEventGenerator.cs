...
namespace Unity.VisualScripting.Community
{
    ...
    public class CustomEventGenerator : NodeGenerator<CustomEvent>
    {
        ...
        public override string GenerateValue(ValueOutput output, ControlGenerationData data)
        {
            ...
            {
                var callCode = CodeBuilder.CallCSharpUtilityExtensitionMethod(null, "args".VariableHighlight(), MakeClickableForThisUnit(nameof(CSharpUtility.GetArgument)), Unit.argumentPorts.IndexOf(output).As().Code(false), "typeof".ConstructHighlight() + "(" + (data.GetExpectedType() ?? typeof(object)).As().CSharpName(false, true) + ")");
