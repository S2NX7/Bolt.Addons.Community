...
{
    [NodeGenerator(typeof(SelectiveExpose))]
    public sealed class SelectiveExposeGenerator : NodeGenerator<SelectiveExpose>
    {
        public SelectiveExposeGenerator(SelectiveExpose unit) : base(unit)
        {
        }
